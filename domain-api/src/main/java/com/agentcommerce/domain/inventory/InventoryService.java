...
public class InventoryService {
    ...
    private void requireManager(UUID userId,UUID locationId){if(!vendors.canManageLocation(userId,locationId))throw new InventoryAccessDeniedException("An active location manager membership is required");}
}